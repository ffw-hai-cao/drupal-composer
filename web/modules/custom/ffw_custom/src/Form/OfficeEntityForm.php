...
/**
 * Form controller for Office information edit forms.
 *
 * @ingroup ffw_custom
 */
class OfficeEntityForm extends ContentEntityForm {
  ...
  /**
   * Constructs a new OfficeEntityForm.
   *
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    switch ($status) {
      case SAVED_NEW:
        $this->messenger()->addMessage($this->t('Created the %label Office information.', [
          '%label' => $entity->label(),
        ]));
        break;

      default:
        $this->messenger()->addMessage($this->t('Saved the %label Office information.', [
          '%label' => $entity->label(),
        ]));
    }
